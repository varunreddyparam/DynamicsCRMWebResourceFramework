...
(function (window, undefined) {
    ...
    Globalize.localize = function (key, cultureSelector) {
        return Globalize.findClosestCulture(cultureSelector).messages[key] ||
              Globalize.cultures["default"].messages[key];
    };

    Globalize.parseDate = function (value, formats, culture) {
        culture = Globalize.findClosestCulture(culture);
    ...
    Globalize.culture = function (cultureSelector) {
        ...
        // getter
        return Globalize.findClosestCulture(cultureSelector) || Globalize.cultures["default"];
    };
